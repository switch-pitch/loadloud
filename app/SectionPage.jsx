...
const SECTION_ITEMS = {
  ...
  promo: {
    ...
    href: "/promo",
    intro: [
      "loadloud promo - промо-направление полного цикла.",
      "делаем рекламные кампании, запусковые ролики и контент для диджитал-каналов.",
      "от идеи до финального монтажа - под ключ."
    ]
  },
  ai: {
    label: "AI",
    href: "/ai",
    intro: [
      "loadloud AI - креатив с нейросетями и продакшн нового типа.",
      "собираем AI-визуал, гибридные пайплайны и быстрые экспериментальные концепты.",
      "быстро проверяем гипотезы и масштабируем работающие решения."
    ]
  }
};
...
export default function SectionPage({ sectionKey = "studio" }) {
  const isStudioPage = sectionKey === "studio";
      ...
      <section className="info-panel" hidden={!infoOpen}>
        <div className="info-content">
          <p className="contact-intro">
            {currentSection.intro[0]}
            <br />
            {currentSection.intro[1]}
            <br />
            {currentSection.intro[2]}
          </p>
